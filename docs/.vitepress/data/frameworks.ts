/**
 * The frameworks Diffine ships for, and the one axis of this site that is not a
 * language.
 *
 * A page says the same things about a comparison whichever package a reader
 * installs — the same options, the same reasons, the same rows coming out the
 * same way — and only the code, the argument names and the install line differ.
 * So the two are not two sites and not two folders: they are one page with the
 * parts that differ marked up, and this file is what marks them.
 *
...
export const FRAMEWORKS: FrameworkInfo[] = [
  { id: 'react', label: 'React', pkg: 'diffine-react', lang: 'tsx', tint: '#149ECA' },
  { id: 'flutter', label: 'Flutter', pkg: 'diffine', lang: 'dart', tint: '#42A5F5' }
];
 ...
 */
export const FRAMEWORK_STORAGE_KEY = 'diffine-framework';
